<article class="markdown-body entry-content p-5" itemprop="text">
  <h1><a id="user-content--fastDelivery" class="anchor" aria-hidden="true" href="#-fastDelivery"><svg
        class="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16"
        aria-hidden="true"></svg></a>
    <g-emoji class="g-emoji" alias="notebook"
      fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/1f4d3.png">📓</g-emoji> fastDelivery
  </h1>
  ...
  <p>fastDelivery is a Desktop application to manage delivery.</p>
  ...
  <p>fastDelivery is a Desktop application build with JavaFX using files as a Database.</p>
    <p>See <a href="https://github.com/moustaphaOut/fastDelivery">fastDelivery</a> here</p>
  ...
  <h2><a id="user-content--screenshots" class="anchor" aria-hidden="true" href="#-screenshots"><svg
   ...
   <div class="Screenshots">
      <h3>Login</h3>
      <img src="https://raw.githubusercontent.com/moustaphaOut/fastDelivery/master/demoImages/login.JPG"
        alt="login">
    </div>
    <div class="Screenshots">
      <h3>Client Information</h3>
      <img src="https://raw.githubusercontent.com/moustaphaOut/fastDelivery/master/demoImages/Infoclients.JPG"
        alt="Infoclients">
    </div>
    <div class="Screenshots">
      <h3>Order Management</h3>
      <img src="https://raw.githubusercontent.com/moustaphaOut/fastDelivery/master/demoImages/order.JPG"
        alt="order">
    </div>
  ...
  <p>Under <a href="https://github.com/moustaphaOut/fastDelivery/blob/master/LICENSE">MIT license</a> but don't forget to reference :).</p>
